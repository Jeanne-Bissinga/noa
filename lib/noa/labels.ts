...
import type { MissionStatus, CandidateStatus, StageStatus, Interview, InterviewType, RecruitmentInterviewType, DecisionStage, DecisionStatus } from "@/lib/noa/types";
