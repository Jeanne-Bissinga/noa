...
const BTN =
  "inline-flex items-center justify-center gap-2 rounded-xl border border-transparent text-sm font-bold transition-all hover:-translate-y-px";
  ...
  return (
    ...
    >
      ...
      <main>
        <section
          id="accueil"
          className="relative overflow-hidden bg-[#010101] px-6 py-20 text-center text-white min-[641px]:px-8 min-[641px]:py-24"
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-3xl">
            ...
            <p className="mx-auto mb-4 max-w-[672px] text-[16px] leading-[1.75] text-white/60 min-[641px]:text-[17px]">
              Noa vous guide à chaque étape de votre recrutement grâce à une
              méthode simple et reconnue. Vous évaluez, vous comparez, vous
              décidez.
            </p>
            <p className="mx-auto mb-10 text-sm text-white/35">
            ...
            <div className="flex flex-col items-center justify-center gap-4 min-[641px]:flex-row">
              ...
              <Link
                href="/demo"
                className={`${BTN_OUTLINE} w-full px-7 py-3.5 min-[641px]:w-auto`}
              >
                Demander une démo
              </Link>
            </div>
        ...
        <section id="methode" className="bg-gray-50 py-16">
          <div className={CONTAINER}>
            ...
            <p className="mb-10 mt-2 text-sm text-gray-500">
              Un parcours guidé en 4 étapes. Chaque décision reste la vôtre.
            </p>
