...
const ARTICLES: LegalArticle[] = [
  {
    ...
    blocks: [
      { p: "Noa est un projet réalisé dans le cadre d'un cursus de master, à titre pédagogique et non commercial. Aucun paiement n'est collecté et aucune donnée bancaire n'est traitée." },
      { p: "Noa Recrutement est responsable des traitements de données personnelles réalisés pour la gestion du site, des comptes utilisateurs et de la relation avec les entreprises utilisatrices." },
  ...
  },
  {
    ...
    blocks: [
      ...
      { dl: [
        ...
        { term: "Respect d'une obligation légale", def: "lorsque la loi impose la conservation ou la communication de certaines informations ;" },
  ...
  },
  {
    ...
    blocks: [
      { dl: [
        { term: "Données de compte", def: "pendant toute la durée d'utilisation du Service, puis pendant la durée nécessaire au respect de nos obligations légales ou à la gestion d'éventuels litiges ;" },
  ...
  },
  {
    ...
    blocks: [
      ...
      { dl: [
        { term: "Anthropic PBC, États-Unis", def: "traitement des contenus nécessaires aux analyses et aux suggestions de Noa. Sont notamment transmis le contenu des CV importés, afin d'en extraire la fiche candidat, les informations de la mission, pour proposer objectifs, compétences et guides d'entretien, ainsi que les réponses et transcriptions d'entretien, pour évaluer les grilles, produire les synthèses et formuler une recommandation. Les données transmises ne sont pas utilisées pour entraîner les modèles du prestataire." },
