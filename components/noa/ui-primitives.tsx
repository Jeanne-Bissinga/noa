...
// ─── Logo ───────────────────────────────────────────────────────────────────
// `dark` bascule le texte "noa" en noir : le blanc par défaut n'est lisible
// que sur fond sombre, à utiliser partout où le logo seul se retrouve sur un
// fond clair (ex. logo mobile des écrans d'auth, page d'onboarding).
export const NoaLogo = ({ scale = 1, dark = false }: { scale?: number; dark?: boolean }) => {
  const text = dark ? "#010101" : "white";
  return (
